        ...
        do {
            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    System.out.println("Total de usos do cliente " + cliente.getNome() + " no estacionamento: " + totalUsos);
                    break;
                case 3:
                    System.out.print("Digite a placa do veículo: ");
                    placa = scanner.next();
                    double arrecadadoPorVeiculo = cliente.arrecadadoPorVeiculo(placa);
                    System.out.println("O veiculo de placa:  " + placa + " arrecadou no total: " + arrecadadoPorVeiculo);
                    break;
                case 4:
                ...
                case 5:
                    ...
                    System.out.println("Arrecadado no mês do cliente: " + cliente.getNome() + " = " + cliente.arrecadadoNoMes(mes));
                    break;
                case 6:
                    scanner.close();
